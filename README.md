...
**NOTE: IF YOU DON'T HAVE A LINKEDIN API KEY, SWITCH TO THE DEMO BRANCH FOR OPEN-AI-ONLY INTEGRATION. OR ELSE YOU WILL GET AN ERROR MESSAGE WHEN TRYING TO GENERATE LEADS.**
